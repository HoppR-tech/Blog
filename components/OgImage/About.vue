...
<template>
  <div class="w-full h-full flex flex-col justify-center bg-[#020420]">
    <svg
      class="absolute right-0 top-0" width="629" height="593" viewBox="0 0 629 593" fill="none"
    ...
    >
      ...
      <defs>
        <filter
          id="filter0_f_199_94966" x="0.873535" y="-659" width="1255.25" height="1251.52"
    ...
    <div v-if="imageTop" class="absolute top-[100px] right-[80px]">
      <img :src="imageTop" :alt="title" class="w-80 h-80 rounded-lg object-cover" width="320" height="320">
    </div>

    <div v-if="imageBottom" class="absolute bottom-[0px] right-[140px]">
      <img :src="imageBottom" :alt="title" class="w-52 h-52 rounded-full object-cover">
    </div>
  </div>
</template>
