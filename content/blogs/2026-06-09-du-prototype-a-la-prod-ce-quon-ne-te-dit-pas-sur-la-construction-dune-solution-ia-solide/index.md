...
![Graphique de la chaîne partant de l’agent jusqu’à la reformulation en question autonome, passant par les différentes briques](./assets/img1.webp)
...
![Graphique de la liaison d’une réponse aux données dont elle est issue](./assets/img2.webp)
...
![Graphique présentant les 4 briques : golden set, métriques, expérience A/B, offline/online](./assets/img3.webp)
...
![Graphique présentant les 3 couches de garde-fous : entrée, génération et exécution](./assets/img4.webp)
...
![Graphique de toutes les étapes du process renvoyant des métriques observables](./assets/img5.webp)
...
![Graphique de la feedback loop du système en production : boucle instantanée, boucle offline/CI et boucle online](./assets/img6.webp)
